...
Welcome to ``video_test`` contributor's guide.
...
If you experience bugs or general issues with ``video_test``, please have a look
...
You can help improve ``video_test`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``video_test`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``video_test``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/video_test.git
    cd video_test
...
#. Install |pre-commit|_::
   ...
   ``video_test`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/video_test
.. _issue tracker: https://github.com/<USERNAME>/video_test/issues
.. <-- end -->
